...
const List = (list: tList) => {
    ...
    return (
        <>
            <div className="p-3 w-96 h-max min-h-[7rem] rounded-lg space-y-4 shadow bg-gray-900 text-slate-400 border border-[#101204] hover:border-slate-700 transition-all duration-50">
